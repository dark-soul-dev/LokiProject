...
class Utils
{
    public static function createSelection($dao, $columnName)
    {
        return Utils::getColumnByName($dao, $columnName);
    }

    public static function createCondition($dao, $columnName, $obj, $like = false)
    {
    ...
    public static function removeLastString($sourceStr, $str)
    {
        return substr($sourceStr, 0, strlen($sourceStr) - strlen($str));
    }

    public static function getGetterFromColumnName($columnName = "")
    {
    ...
    public static function getPseudoValuesFromColumnArray($columnArray, $includePK = true)
    {
        $fields = "";
    ...
    public static function getFieldsFromColumnArray($columnArray, $includePK=true, $fullInformation=true)
    {
        $fields = "";
        foreach ($columnArray as $column) {
            if (! $includePK && $column->getKey() == "PRIMARY KEY") {
    ...
    private static function getColumnByName($dao, $columnName)
    {
